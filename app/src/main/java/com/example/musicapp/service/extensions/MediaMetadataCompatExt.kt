package com.example.musicapp.service.extensions
...
inline val MediaMetadataCompat.flag
    get() = this.getLong(METADATA_KEY_MUSIC_FLAGS).toInt()
...
inline var MediaMetadataCompat.Builder.flag: Int
    ...
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
        putLong(METADATA_KEY_MUSIC_FLAGS, value.toLong())
    }
...
const val METADATA_KEY_MUSIC_FLAGS = "com.example.musicapp.service.extensions.METADATA_KEY_MUSIC_FLAGS"